...
if __name__ == "__main__":
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=f"lightning_logs/cityscale_training/ckpt/V_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}",
    ...
    tb_logger = TensorBoardLogger("lightning_logs", name="cityscale_train")
